...
#    Updated: 2021/12/03 17:07:30 by astucky          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
override FILES_P	:= parser.c lexer.c pars_tools.c history.c tokenizator.c \
					...
					redir_exp.c	redir_exp2.c complet_pipeline.c
override FILES_E	:= exec.c exec_tools.c simple_cmd.c heredoc.c child_processes.c
